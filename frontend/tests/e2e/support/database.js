...
Cypress.Commands.add('populateAssessments', () => {
  ...
  // Activities
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("1", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Same institution is enrolled and participates", "2024-02-08 10:58:21.402146", "A1", "1",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "1"),
    credentials: credentials
  });
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("2", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Same institution is enrolled and participates", "2024-02-08 10:58:21.402146", "A2", "1",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "1"),
    credentials: credentials
  });
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("3", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Same institution is enrolled and does not participate", "2024-02-08 10:58:21.402146", "A3", "2",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "1"),
    credentials: credentials
  });
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("4", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Same institution is not enrolled", "2024-02-08 10:58:21.402146", "A4", "2",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "1"),
    credentials: credentials
  });
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("5", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Same institution before end date", "2024-08-08 10:58:21.402146", "A5", "2",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "1"),
    credentials: credentials
  });
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple("6", "2024-02-06 17:58:21.402146",'2024-08-06 17:58:21.402146', "Other institution is enrolled and participates", "2024-02-08 10:58:21.402146", "A6", "3",'Lisbon', '2024-08-07 17:58:21.402146', 'APPROVED', "2"),
    credentials: credentials
  });
  // Enrollments
  cy.task('queryDatabase', {
